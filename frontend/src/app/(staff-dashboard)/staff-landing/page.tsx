...
export default function StaffDashboard() {
  ...
  return (
    <main>
      <div className="page-container px-4 sm:px-6 md:px-10 lg:px-16 py-8 sm:py-12 md:py-20 space-y-6 min-h-screen">
        {/* User Profile */}
        <div className="mt-4">
        ...
        <div ref={patientRecordsRef} className="py-8 sm:py-12 md:py-20">
          ...
          <div className="bg-blue-light p-4 sm:p-6 md:p-8 rounded-2xl mt-4 w-full min-h-[200px] sm:min-h-[280px] md:min-h-[360px] flex items-center justify-center overflow-y-auto">
          </div>
        </div>
